  ...
  if (isLoading) {
    return (
      <section className="px-4 py-6 pb-10 sm:px-7">
        <h1 className="mb-6 text-2xl font-bold text-slate-950 dark:text-slate-100">Calendario</h1>
    ...
    <section className="px-4 py-6 pb-10 sm:px-7">
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-slate-950 dark:text-slate-100">Calendario</h1>
