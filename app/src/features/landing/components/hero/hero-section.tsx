...
export default function HeroSection() {
  return (
    <>
    <section className="w-full grid items-center gap-14 lg:grid-cols-[minmax(0,1fr)_minmax(560px,0.95fr)] lg:px-30 px-6">
      <div className="max-w-2xl">
        <div className="mb-8 inline-flex items-center rounded-full border border-[#cfe0ea] bg-[#f3f8fb] px-4 py-2 text-sm font-medium text-[#275D79] shadow-sm">
        ...
        <p className="mt-8 max-w-xl text-xl leading-9 text-slate-400">
          Crea espacios de trabajo, asigna tareas y califica automaticamente
