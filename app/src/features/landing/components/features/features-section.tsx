...
export default function FeatureSection() {
    return (
        <section id="funciones" className="py-20 border-t-2 border-[#eaeaea]">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div key={index} className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
